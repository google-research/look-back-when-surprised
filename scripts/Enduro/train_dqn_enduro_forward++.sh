...
cd ..
python -W ignore -m src.main --exp_name dqn_enduro_forward++ --algo dqn --replay_buffer_sampler forward++ --env enduro --train --seed $1 --snapshot_dir /mnt/disk1/ramnathk/ >/dev/null 2>&1 &
