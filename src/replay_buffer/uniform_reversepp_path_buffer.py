...
class UniformReversePPPathBuffer(OptimisticPathBuffer):
    ...
    def update_starts(self, num_timesteps, temp=0.7):
        self.diverse_set = (-self._sample_dist).argsort()[:int(num_timesteps*temp)]
